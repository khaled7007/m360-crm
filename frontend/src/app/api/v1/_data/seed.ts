...
export const PRODUCTS = [
  {
    id: "prod-001",
    name_ar: "تمويل فواتير المقاولين",
    ...
    admin_fee_pct: null,
    collateral: null,
    sales_notes: "مناسب للمقاولين الذين يحتاجون سيولة فورية مقابل فواتيرهم المعتمدة",
    credit_notes: null,
    is_active: true,
  ...
  {
    id: "prod-002",
    name_ar: "تمويل التطوير العقاري",
    product_category: "real_estate",
    re_program: "leadership",
    max_amount: 10000000,
    financing_pct: null,
    min_tenor_months: 12,
    max_tenor_months: 60,
    profit_rate: 4.5,
    admin_fee_pct: 1.0,
    collateral: "رهن العقار موضوع المشروع",
    sales_notes: "برنامج الريادة للمطورين الناشئين — حتى 10 مليون ريال",
    credit_notes: "يُشترط تقديم دراسة جدوى وعقد بيع أو إيجار مسبق",
    is_active: true,
    created_at: "2026-01-10T00:00:00Z",
    updated_at: "2026-01-10T00:00:00Z",
  },
  {
    ...
    profit_rate: 4.0,
    admin_fee_pct: 0.75,
    collateral: "رهن العقار + ضمان شخصي",
    sales_notes: "برنامج النمو للمطورين ذوي السجل الجيد — حتى 20 مليون ريال",
    credit_notes: "يُشترط سجل تطوير عقاري لا يقل عن مشروعين مكتملين",
    is_active: true,
    created_at: "2026-01-10T00:00:00Z",
    updated_at: "2026-01-10T00:00:00Z",
  },
  {
    ...
    profit_rate: 3.75,
    admin_fee_pct: 0.5,
    collateral: "رهن درجة أولى على العقار",
    sales_notes: "برنامج التوسع للمطورين الكبار — حتى 70% من قيمة العقار",
    credit_notes: "يُشترط تقييم عقاري معتمد من مقيّم مرخص لتحديد نسبة LTV",
    is_active: true,
    created_at: "2026-01-10T00:00:00Z",
    updated_at: "2026-01-10T00:00:00Z",
  },
